...
The following tables includes excerpts from the Aug 23, 2005 LSST Baseline
Design Summary (available from http://www.lsstcorp.org)
...
Aperture                   &  8.4 m                                 \\
Effective aperture         &  6.5 m                                \\
Effective \'etendue (A$\Omega$)  &  318 m$^2$deg$^2$                \\
Plate Scale                &  50.9 microns/arcsec (0.2 arcsec pix)  \\
Pixel count                &  3.2 Gigapixel                         \\
Wavelength Coverage        &  320 -- 1050 nm                        \\
Standard exposure sequence &  39 sec total for 2x15 sec exposure    \\
                           &  (with slew, without filter change)    \\
\hline
\end{tabular}
}
\caption{The LSST September 2007 Baseline Design Parameters.}
\end{table}
...
\newpage
\appendix{\large\bf Appendix D: The Seeing Distribution at the Cerro Pachon site}
