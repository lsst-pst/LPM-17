...
\begin{figure}[h!]\centering
\includegraphics[width=13cm]{CerroPachonSeeing.eps}
...
\newpage
\vskip 0.1in
\appendix{\large\bf Appendix E: Document History}

\bigskip

\begin{enumerate}
\item {\bf Version 4.3.3 (September 2007)} The first version approved by the LSST Board, placed under the Change
 Control Board, and made public.
\item {\bf Version 5.1.1 (March 2010)} The most important changes, relative to v4.3.3, are:
\begin{itemize}
